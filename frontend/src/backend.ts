...
export class Backend implements backendInterface {
    ...
    async getPatternConfigs(): Promise<Array<PatternConfig>> {
        if (this.processError) {
            try {
                const result = await this.actor.getPatternConfigs();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getRecentSignalHistory(arg0: bigint): Promise<Array<SignalHistoryEntry>> {
        if (this.processError) {
            try {
                const result = await this.actor.getRecentSignalHistory(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getSignalHistory(): Promise<Array<SignalHistoryEntry>> {
        if (this.processError) {
            try {
                const result = await this.actor.getSignalHistory();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async savePatternConfig(arg0: string, arg1: string, arg2: boolean, arg3: bigint): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.savePatternConfig(arg0, arg1, arg2, arg3);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async saveSignalHistory(arg0: string, arg1: string, arg2: string, arg3: string, arg4: bigint): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.saveSignalHistory(arg0, arg1, arg2, arg3, arg4);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
